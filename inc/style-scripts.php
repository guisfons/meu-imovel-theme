...
function themeFiles() {
    ...
    wp_register_script('jquery-mask', get_stylesheet_directory_uri() . '/assets/js/jquery.mask.min.js', array('jquery'), null, true);
    wp_enqueue_script('jquery-mask');

    wp_register_script('main-js', get_stylesheet_directory_uri() . '/assets/js/main.js', array('jquery', 'jquery-mask'), null, true);
